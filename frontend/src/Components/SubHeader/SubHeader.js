  ...
  return (
    <div className="Sub_header">
      <div className="options" >
        <>
        <div className="price_filter filter" onClick={() => setActivePrice(!ActivePrice)}>
          <span>price</span>
        ...
        <>
        <div className="rating_filter filter" onClick={()=>setActiveRating(!ActiveRating)}>
          <span>ratings</span>
          {ActiveRating ?<IoClose />: <IoIosArrowDown /> }

        </div>
        {ActiveRating && (
          <div className="list rating" onClick={() => setActiveRating(!ActiveRating)}>
            {ratingVal.map((val) => (
        ...
        <>
        <div className="category_filter filter" onClick={()=>setActivecategory(!Activecategory)}>
          <span>Category</span>
          {Activecategory ?<IoClose />: <IoIosArrowDown /> }

        </div>
        {Activecategory && (
          <div className="list category" onClick={() => setActivecategory(!Activecategory)}>
            {categoryVal.map((val) => (
