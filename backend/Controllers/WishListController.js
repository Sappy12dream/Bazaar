...
exports.myWishList = AsyncErrorHandler(async(req,res,next)=>{
    const items = await Wishlist.find({user:req.user._id}).populate("product", "name description price ratings images category numberOfReviews reviews artist artistName createdAt",)
