...
const { getAllProducts, createProduct, updateProduct, deleteProduct, getProduct, createProdutReview, getAllReviews, deleteReview } = require('../Controllers/ProductController');
